    ...
    public partial class Login : MetroForm
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MetroMessageBox.Show(this, "Enter User Name", "WeighBridge", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    intValidate = 1;
                }
                else if (txtPassword.Text.Trim() == "")
                {
                    MetroMessageBox.Show(this, "Enter password", "WeighBridge", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    intValidate = 1;
                }
                if (intValidate == 0)
                {
                    ...
                    if (objResult != null)
                    {
                        ...
                        if (objResult.ResultDt.Rows.Count > 0)
                        {
                            ...
                            if (Program.intRoleId == 1 || Program.intRoleId == 4)
                            {
                                this.Hide();
                            ...
                            {
                                MetroMessageBox.Show(this, "You Are Not Autorized User", "WeighBridge", MessageBoxButtons.OK, MessageBoxIcon.Error);
                            }

                        }
                        else
                        {
                            MetroMessageBox.Show(this, "Invalid User Name or password", "WeighBridge", MessageBoxButtons.OK, MessageBoxIcon.Error);
